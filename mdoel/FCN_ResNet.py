...
from mdoel.base_model import build_backbone
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

class FCN_ResNet(nn.Module):
    def __init__(self, num_classes, backbone='resnet50', out_stride=32, mult_grid=False):
...
#     model = FCN_ResNet(num_classes=3, backbone='resnet101')
#     print(summary(model, (3, 512, 512), device="cpu"))
